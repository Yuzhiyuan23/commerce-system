...
export async function getAdminOrderDetail(orderId: number): Promise<OrderDetail> {
  return fetchAdminJson<OrderDetail>(`/api/admin/orders/${orderId}`);
}
...
// Aliases for log center
export const getLoginLogs = getServerLoginLogs;
export const getOperationLogs = getServerOperationLogs;
export const getProductViewLogs = getServerViewLogs;
