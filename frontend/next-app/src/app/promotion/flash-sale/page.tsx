...
export default async function FlashSalePage() {
  const result = await getServerStorefrontProductsByTag("限时秒杀", { pageSize: 24 });
  ...
  return (
    <main className="page-shell">
      <div className="page-stack">
        ...
        {/* Promotion Banner */}
        <section className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-amber-500 to-orange-500 px-6 py-8 text-white">
          ...
          <div className="relative">
            <div className="flex items-center gap-2">
              ...
              <h1 className="text-2xl font-black md:text-3xl">限时秒杀</h1>
            </div>
            <p className="mt-2 text-sm font-medium text-white/90">爆款手机，限时特惠，手慢无</p>
          </div>
        </section>
        ...
        <section className="flex flex-col gap-4">
          <div className="flex items-center gap-3">
            <div className="h-6 w-1 rounded-full bg-gradient-to-b from-amber-400 to-orange-400" />
          ...
          {result.items.length > 0 ? (
            ...
            <div className="surface-card border-dashed px-6 py-10 text-center">
              <p className="text-sm text-[var(--text-secondary)]">暂无秒杀商品</p>
