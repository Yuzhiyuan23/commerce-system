...
export default async function OfficialGoodsPage() {
  const result = await getServerStorefrontProductsByTag("官方好货", { pageSize: 24 });
  ...
  return (
    <main className="page-shell">
      <div className="page-stack">
        ...
        {/* Promotion Banner */}
        <section className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-teal-500 to-cyan-500 px-6 py-8 text-white">
          ...
          <div className="relative">
            <div className="flex items-center gap-2">
              ...
              <h1 className="text-2xl font-black md:text-3xl">官方好货</h1>
            </div>
            <p className="mt-2 text-sm font-medium text-white/90">正品保障，品质优选，售后无忧</p>
          </div>
        </section>
        ...
        <div className="flex gap-3">
          ...
          <Link
            className="flex-1 rounded-xl bg-gradient-to-r from-rose-400 to-pink-500 px-4 py-3 text-center text-sm font-bold text-white shadow-md transition-transform hover:scale-[1.02]"
        ...
        <section className="flex flex-col gap-4">
          <div className="flex items-center gap-3">
            <div className="h-6 w-1 rounded-full bg-gradient-to-b from-teal-400 to-cyan-400" />
          ...
          {result.items.length > 0 ? (
            ...
            <div className="surface-card border-dashed px-6 py-10 text-center">
              <p className="text-sm text-[var(--text-secondary)]">暂无官方好货</p>
