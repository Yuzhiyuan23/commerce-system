  ...
  return (
    <main className="min-h-screen px-6 py-12">
      ...
      <div className="mx-auto max-w-5xl pb-4">
        <Link
          href="/"
          className="inline-flex items-center gap-2 text-sm font-medium text-black/60 transition hover:text-[var(--accent)]"
        >
      ...
      <section className="mx-auto grid max-w-5xl gap-8 rounded-[32px] border border-black/10 bg-[var(--surface)] p-8 shadow-[0_20px_60px_rgba(74,42,18,0.08)] md:grid-cols-[1.1fr_0.9fr] md:p-12">
        <div className="flex flex-col justify-between gap-6">
          <div className="space-y-4">
            ...
            <h1 className="text-4xl font-bold tracking-tight">登录你的 commerce-system 账号</h1>
          ...
          <div className="rounded-[24px] border border-[var(--accent)]/15 bg-white/70 p-5 text-sm leading-6 text-black/65">
            <p>管理员测试账号：</p>
            <p className="font-medium text-[var(--foreground)]">admin@commerce-system.local / Admin@123456</p>
          </div>
        </div>
