...
const NAV_ITEMS: NavItem[] = [
  ...
  { href: "/admin/categories", label: "分类管理", roles: ["ADMIN", "SALES"] },
  { href: "/admin/products", label: "商品管理", roles: ["ADMIN", "SALES"] },
  { href: "/admin/orders", label: "订单管理", roles: ["ADMIN", "SALES"] },
  { href: "/admin/dashboard", label: "仪表盘", roles: ["ADMIN", "SALES"] },
  { href: "/admin/analytics/overview", label: "数据分析", roles: ["ADMIN", "SALES"] },
  { href: "/admin/logs", label: "日志中心", roles: ["ADMIN"] },
