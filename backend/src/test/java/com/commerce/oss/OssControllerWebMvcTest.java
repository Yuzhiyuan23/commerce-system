...
import com.commerce.modules.oss.dto.OssUploadResult;
import com.commerce.modules.oss.service.OssService;
import com.commerce.modules.oss.web.OssController;
...
class OssControllerWebMvcTest {
    ...
    void securityConfigAllowsAdminAndSalesForAdminApis() throws Exception {
        String securityConfig = Files.readString(Path.of("src/main/java/com/commerce/framework/security/SecurityConfig.java"));
