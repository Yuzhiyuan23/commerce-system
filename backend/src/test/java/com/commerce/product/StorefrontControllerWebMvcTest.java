...
import com.commerce.framework.web.ApiExceptionHandler;
import com.commerce.modules.product.service.StorefrontProductService;
import com.commerce.modules.product.web.StorefrontCategoryController;
import com.commerce.modules.product.web.StorefrontProductController;
    ...
    void storefrontControllersSerializeBrowseResponses() throws Exception {
        ...
        when(storefrontProductService.listHomeProducts(anyInt(), anyInt()))
            .thenReturn(new PagedResponse<>(
                List.of(new ProductCardResponse(11L, 1L, "Cotton Tee", BigDecimal.valueOf(99), "https://img.example.com/tee.jpg", null)),
                1,
                12,
                1));
