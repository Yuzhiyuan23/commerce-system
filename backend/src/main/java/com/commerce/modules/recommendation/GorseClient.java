package com.commerce.modules.recommendation;
...
public class GorseClient {
    ...
    public GorseClient(
        @Value("${commerce.recommendation.gorse.endpoint:http://localhost:8088}") String endpoint,
        @Value("${commerce.recommendation.gorse.enabled:false}") boolean enabled,
        @Value("${commerce.recommendation.gorse.timeout:2s}") Duration timeout
    ) {
