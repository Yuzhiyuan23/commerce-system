package com.commerce.modules.payment.web;
...
import static com.commerce.modules.payment.dto.PaymentDtos.CloseExpiredPaymentsResponse;
...
import com.commerce.modules.payment.service.PaymentService;
import com.commerce.modules.payment.service.PaymentCloseService;
...
public class PaymentController {
    ...
    public PaymentActionResponse mockPay(@PathVariable Long orderId, Authentication authentication) {
        return paymentService.mockPaySuccess(requireUserId(authentication), orderId);
    }
