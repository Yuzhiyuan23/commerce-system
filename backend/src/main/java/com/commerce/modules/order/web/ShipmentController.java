...
import static com.commerce.modules.order.dto.ShipmentDtos.ShipOrderRequest;
...
public class ShipmentController {
    ...
    public OrderDetailResponse getAdminOrderDetail(@PathVariable Long orderId, Authentication authentication) {
        requireStaff(authentication);
        return shipmentService.getAdminOrderDetail(orderId);
    }
    ...
    @OperationLog(action = "REFUND_ORDER", targetType = "ORDER", targetIdExpr = "#orderId")
    public OrderDetailResponse refundOrder(
        @PathVariable Long orderId,
        Authentication authentication
    ) {
        return shipmentService.refundOrder(requireStaff(authentication), orderId);
    }
