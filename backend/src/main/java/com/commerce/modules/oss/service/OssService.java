package com.commerce.modules.oss.service;
...
import com.commerce.modules.oss.config.OssProperties;
    ...
    private OSS ossClient() {
        ...
        if (local == null) {
            synchronized (this) {
                local = lazyOssClient;
                if (local == null) {
                    log.info("Initializing OSS client with endpoint: {}, bucket: {}, region: {}",
