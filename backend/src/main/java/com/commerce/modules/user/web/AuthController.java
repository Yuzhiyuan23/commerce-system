package com.commerce.modules.user.web;

import static com.commerce.modules.user.dto.AuthDtos.AuthUserResponse;
import static com.commerce.modules.user.dto.AuthDtos.LoginRequest;
import static com.commerce.modules.user.dto.AuthDtos.RegisterRequest;
...
import com.commerce.modules.user.service.UserAccountService;
...
public class AuthController {
    ...
    public ResponseEntity<AuthUserResponse> register(@Valid @RequestBody RegisterRequest request) {
        AuthUser authUser = userAccountService.register(request.email(), request.password(), request.nickname(), request.role());
